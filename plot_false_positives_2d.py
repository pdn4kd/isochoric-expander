...
for minplanets, maxplanets in nplanets:
	...
	#f5ppk_fit.scatter(stars["per"], stars["K"], color="gray", s=1)
	f5ppk_fit.scatter(f5p_yes_per_mid, f5p_yes_K_mid, label="Recovered", color="blue")
	f5ppk_fit.errorbar(f5p_yes_per_mid, f5p_yes_K_mid, xerr=[f5p_yes_per_err_minus, f5p_yes_per_err_plus], yerr=[f5p_yes_K_err_minus, f5p_yes_K_err_plus], color="blue", fmt='o')
	f5ppk_fit.scatter(f5p_mar_per_mid, f5p_mar_K_mid, label="Marginal", color="black")
	f5ppk_fit.errorbar(f5p_mar_per_mid, f5p_mar_K_mid, xerr=[f5p_mar_per_err_minus, f5p_mar_per_err_plus], yerr=[f5p_mar_K_err_minus, f5p_mar_K_err_plus], color="black", fmt='o')
	f5ppk_fit.scatter(f5p_no_per_mid, f5p_no_K_mid, label="Excluded", color="gray")
	f5ppk_fit.errorbar(f5p_no_per_mid, f5p_no_K_mid, xerr=[f5p_no_per_err_minus, f5p_no_per_err_plus], yerr=[f5p_no_K_err_minus, f5p_no_K_err_plus], color="gray", fmt='o')
	f5ppk_fit.scatter(f5p_false_per_mid, f5p_false_K_mid, label="False Positive", color="red")
	f5ppk_fit.errorbar(f5p_false_per_mid, f5p_false_K_mid, xerr=[f5p_false_per_err_minus, f5p_false_per_err_plus], yerr=[f5p_false_K_err_minus, f5p_false_K_err_plus], color="red", fmt='o')
	...
	#f5ppk_false.scatter(stars["per"], stars["K"], color="gray", s=1)
	f5ppk_false.scatter(f5p_yes_per, f5p_yes_K, label="Recovered", color="blue")
	f5ppk_false.scatter(f5p_mar_per, f5p_mar_K, label="Marginal", color="black")
	f5ppk_false.scatter(f5p_no_per, f5p_no_K, label="Excluded", color="gray")
	f5ppk_false.scatter(f5p_false_per, f5p_false_K, label="False Positive", color="red")
