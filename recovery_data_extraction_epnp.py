...
planetfits_results.write("Star,num,PlanetNumber,"+file_postfix+"_per_min,"+file_postfix+"_per_mid,"+file_postfix+"_per_max,"+file_postfix+"_per_err_minus,"+file_postfix+"_per_err_plus,tc_min,tc_mid,tc_max,tc_err_minus,tc_err_plus,"+file_postfix+"_per_min,"+file_postfix+"_per_mid,"+file_postfix+"_per_max,"+file_postfix+"_per_err_minus,"+file_postfix+"_per_err_plus\n")
