...
for minplanets, maxplanets in nplanets:
	...
	f5pp.errorbar(f5p_yes_per, f5pΔ_yes_per, yerr=[f5perrm_yes_per, f5perrp_yes_per], color="#0000FF", fmt='.')
	f5pp.scatter(f5p_yes_per, f5pΔ_yes_per, color="#0000FF", label="Recovered", s=2.5)
	f5pp.errorbar(f5p_mar_per, f5pΔ_mar_per, yerr=[f5perrm_mar_per, f5perrp_mar_per], color="#FF0000", fmt='.')
	f5pp.scatter(f5p_mar_per, f5pΔ_mar_per, color="#FF0000", label="Marginal", s=2.5)
	f5pp.errorbar(f5p_no_per, f5pΔ_no_per, yerr=[f5perrm_no_per, f5perrp_no_per], color="#000000", fmt='.')
	f5pp.scatter(f5p_no_per, f5pΔ_no_per, color="#000000", label="Excluded", s=2.5)
	f5pp.errorbar(f5p_false_per, f5pΔ_false_per, yerr=[f5perrm_false_per, f5perrp_false_per], color="#00AA00", fmt='.')
	f5pp.scatter(f5p_false_per, f5pΔ_false_per, color="#00AA00", label="False Positive", s=2.5)
	f5pp.set_xscale('log')
	...
	f5pk.errorbar(f5p_yes_k, f5pΔ_yes_k, yerr=[f5perrm_yes_k, f5perrp_yes_k], color="#0000FF", fmt='.')
	f5pk.scatter(f5p_yes_k, f5pΔ_yes_k, color="#0000FF", label="Recovered", s=2.5)
	f5pk.errorbar(f5p_mar_k, f5pΔ_mar_k, yerr=[f5perrm_mar_k, f5perrp_mar_k], color="#FF0000", fmt='.')
	f5pk.scatter(f5p_mar_k, f5pΔ_mar_k, color="#FF0000", label="Marginal", s=2.5)
	f5pk.errorbar(f5p_no_k, f5pΔ_no_k, yerr=[f5perrm_no_k, f5perrp_no_k], color="#000000", fmt='.')
	f5pk.scatter(f5p_no_k, f5pΔ_no_k, color="#000000", label="Excluded", s=2.5)
	f5pk.errorbar(f5p_false_k, f5pΔ_false_k, yerr=[f5perrm_false_k, f5perrp_false_k], color="#00AA00", fmt='.')
	f5pk.scatter(f5p_false_k, f5pΔ_false_k, color="#00AA00", label="False Positive", s=2.5)
	f5pk.set_xscale('log')
	...
	f5pe.errorbar(f5p_yes_e, f5pΔ_yes_e, yerr=[f5perrm_yes_e, f5perrp_yes_e], color="#0000FF", fmt='.')
	f5pe.scatter(f5p_yes_e, f5pΔ_yes_e, color="#0000FF", label="Recovered", s=2.5)
	f5pe.errorbar(f5p_mar_e, f5pΔ_mar_e, yerr=[f5perrm_mar_e, f5perrp_mar_e], color="#FF0000", fmt='.')
	f5pe.scatter(f5p_mar_e, f5pΔ_mar_e, color="#FF0000", label="Marginal", s=2.5)
	f5pe.errorbar(f5p_no_e, f5pΔ_no_e, yerr=[f5perrm_no_e, f5perrp_no_e], color="#000000", fmt='.')
	f5pe.scatter(f5p_no_e, f5pΔ_no_e, color="#000000", label="Excluded", s=2.5)
	f5pe.errorbar(f5p_false_e, f5pΔ_false_e, yerr=[f5perrm_false_e, f5perrp_false_e], color="#00AA00", fmt='.')
	f5pe.scatter(f5p_false_e, f5pΔ_false_e, color="#00AA00", label="False Positive", s=2.5)
	f5pe.set_xscale('log')
